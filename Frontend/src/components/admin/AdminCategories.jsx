...
const AdminCategories = () => {
    ...
    const handleDelete = async (id) => {
        if (!window.confirm('Are you sure? This will fail if jobs are still using this category.')) return;
        try {
    ...
    return (
        <div className="space-y-6 animate-fadeInUp">
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-black text-slate-800 tracking-tight">Job Categories</h2>
                <button 
            ...
            {showModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <form onSubmit={handleSubmit} className="relative bg-white rounded-[2rem] shadow-2xl w-full max-w-sm p-8 anim-scaleUp border border-slate-100">
                        <h3 className="text-xl font-bold text-slate-800 mb-6">{editingCategory ? 'Edit Category' : 'Create Category'}</h3>
                        ...
                        <div className="space-y-4 mb-8">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <textarea 
                                    ...
                                    placeholder="Jobs related to coding and tech..."
                                    value={description}
