...
export default function HeroSearch({ onSearch, totalJobs }) {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-14">
      ...
      <div className="max-w-[1320px] mx-auto px-6 lg:px-10 relative z-10">
        <h1 className="anim-fadeUp text-3xl lg:text-4xl font-black tracking-tight">Explore <span className="grad-text">{totalJobs || '...'} Part-Time Jobs</span></h1>
        ...
        <div className="anim-fadeUp-d2 mt-6 bg-white/10 backdrop-blur-md rounded-2xl border border-white/10 p-2 flex flex-col sm:flex-row gap-2 max-w-3xl">
          <div className="flex-1 flex items-center bg-white/10 rounded-xl px-3">
            ...
            <input 
              className="w-full bg-transparent border-none focus:ring-0 placeholder-slate-400 text-white h-12 px-3 text-sm" 
          ...
          <button 
            ...
            className="h-12 px-7 bg-gradient-to-r from-primary to-primary-dk text-white rounded-xl font-bold text-sm hover:shadow-lg hover:shadow-primary/30 transition-all whitespace-nowrap flex items-center gap-2"
          >
