        ...
        <div className="flex-1 flex items-center justify-end gap-3">
          {isLoggedIn ? (
            <>
              ...
              <Link to="/profile" className="w-9 h-9 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center text-white text-sm font-bold shadow-md hover:shadow-lg transition-all">
                ME
              </Link>
            </>
          ) : (
